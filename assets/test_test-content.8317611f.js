import{_ as e}from"./TheArticle.745a8132.js";import{f as t,o as l}from"./app.5fa76bb0.js";const h="\u9875\u9762\u5185\u5BB9\u6D4B\u8BD5",m="2021-02-14",d="misc",g=["test"],y={__name:"test_test-content",setup(p,{expose:n}){const s={title:"\u9875\u9762\u5185\u5BB9\u6D4B\u8BD5",date:"2021-02-14",category:"misc",tags:["test"]};return n({frontmatter:s}),(o,r)=>{const a=e;return l(),t(a,{frontmatter:s,inner:`<div><p>\u9875\u9762\u5185\u5BB9\u6E32\u67D3\u6548\u679C\u7684\u6D4B\u8BD5\uFF0C\u517C\u4F5C Markdown \u53C2\u8003\u3002</p>
<!-- more -->
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf"># H1
## H2
### H3
#### H4
##### H5
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">Emphasis, aka italics, with *asterisks* or _underscores_.
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">1. First ordered list item
2. Another item
  * Unordered sub-list.
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">[I&#39;m an inline-style link](https://www.google.com)
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">Inline \`code\` has \`back-ticks around\` it.
</span></span></code></pre>
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #ABB2BF">s </span><span style="color: #56B6C2">=</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">&quot;Python syntax highlighting&quot;</span></span>
<span class="line"><span style="color: #56B6C2">print</span><span style="color: #ABB2BF"> s</span></span>
<span class="line"></span></code></pre>
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #ABB2BF">include </span><span style="color: #C678DD">&lt;</span><span style="color: #ABB2BF">iostream</span><span style="color: #C678DD">&gt;</span></span>
...
<span class="line"></span></code></pre>
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">No language indicated, so no syntax highlighting in Markdown Here (varies on Github).
But let&#39;s throw in a &lt;b&gt;tag&lt;/b&gt;.
</span></span></code></pre>
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">Colons can be used to align columns.
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">&gt; Blockquotes are very handy in email to emulate reply text.
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">&lt;dl&gt;
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">Three or more...
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">Here&#39;s a line for us to start with.
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #abb2bf">Inline math: $\\varphi = \\dfrac{1+\\sqrt5}{2}= 1.6180339887\u2026$
...
</div>`})}}};export{d as category,m as date,y as default,g as tags,h as title};
