import{_ as l}from"./TheArticle.d3d5fc65.js";import{o as p,f as o}from"./app.c96d98ee.js";const i="Tailwind CSS \u521D\u63A2",B="2021-02-04T00:00:00.000Z",F="comp",d=["frontend"],A=["CSS"],h={setup(e,{expose:n}){const s={title:"Tailwind CSS \u521D\u63A2",date:"2021-02-04T00:00:00.000Z",category:"comp",tags:["frontend"],keywords:["CSS"]};return n({frontmatter:s}),(c,t)=>{const a=l;return p(),o(a,{frontmatter:s,inner:`<div><p>Tailwind CSS \u4ECE\u771F\u9999\u5230\u653E\u5F03\u7684\u4E2A\u4EBA\u7ECF\u5386\u3002</p>
<!-- more -->
