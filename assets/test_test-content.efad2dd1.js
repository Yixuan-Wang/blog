import{_ as a}from"./TheArticle.9b29acdd.js";import{o as t,e as l}from"./vendor.e22f72d7.js";import"./app.8ec94d89.js";const d="\u9875\u9762\u5185\u5BB9\u6D4B\u8BD5",m="2021-02-14",g="misc",y=["test"],f={setup(o,{expose:n}){const s={title:"\u9875\u9762\u5185\u5BB9\u6D4B\u8BD5",date:"2021-02-14",category:"misc",tags:["test"]};return n({frontmatter:s}),(r,i)=>{const e=a;return t(),l(e,{frontmatter:s,inner:`<div><p>\u9875\u9762\u5185\u5BB9\u6E32\u67D3\u6548\u679C\u7684\u6D4B\u8BD5\uFF0C\u517C\u4F5C Markdown \u53C2\u8003\u3002</p>
<!-- more -->
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff"># H1
## H2
### H3
#### H4
##### H5
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">Emphasis, aka italics, with *asterisks* or _underscores_.
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">1. First ordered list item
2. Another item
  * Unordered sub-list.
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">[I&#39;m an inline-style link](https://www.google.com)
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">Inline \`code\` has \`back-ticks around\` it.
...
<span class="line"><span style="color: #88C0D0">alert</span><span style="color: #D8DEE9FF">(</span><span style="color: #D8DEE9">s</span><span style="color: #D8DEE9FF">)</span><span style="color: #81A1C1">;</span></span>
...
<pre><code class="language-python"><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #D8DEE9FF">s </span><span style="color: #81A1C1">=</span><span style="color: #D8DEE9FF"> </span><span style="color: #ECEFF4">&quot;</span><span style="color: #A3BE8C">Python syntax highlighting</span><span style="color: #ECEFF4">&quot;</span></span>
<span class="line"><span style="color: #88C0D0">print</span><span style="color: #D8DEE9FF"> s</span></span>
...
<span class="line"></span></code></pre></div></code></pre>
<pre><code class="language-cpp"><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #D8DEE9FF">include </span><span style="color: #81A1C1">&lt;</span><span style="color: #D8DEE9FF">iostream</span><span style="color: #81A1C1">&gt;</span></span>
...
<span class="line"><span style="color: #D8DEE9FF">  cout </span><span style="color: #81A1C1">&lt;&lt;</span><span style="color: #D8DEE9FF"> </span><span style="color: #ECEFF4">&quot;</span><span style="color: #A3BE8C">Hello World!</span><span style="color: #ECEFF4">&quot;</span><span style="color: #81A1C1">;</span></span>
...
<span class="line"></span></code></pre></div></code></pre>
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">No language indicated, so no syntax highlighting in Markdown Here (varies on Github).
But let&#39;s throw in a &lt;b&gt;tag&lt;/b&gt;.
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">Colons can be used to align columns.
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">&gt; Blockquotes are very handy in email to emulate reply text.
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">&lt;dl&gt;
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">Three or more...
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">Here&#39;s a line for us to start with.
...
<pre><code><div class="shiki-container"><pre class="shiki shiki-dark" style="background-color: #2e3440ff"><code><span class="line"><span style="color: #d8dee9ff">Inline math: $\\varphi = \\dfrac{1+\\sqrt5}{2}= 1.6180339887\u2026$
...
</div>`})}}};export{g as category,m as date,f as default,y as tags,d as title};
