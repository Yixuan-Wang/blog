import{_ as l}from"./TheArticle.745a8132.js";import{f as p,o}from"./app.5fa76bb0.js";const i="Tailwind CSS \u521D\u63A2",y="2021-02-04T00:00:00.000Z",A="comp",d=["frontend"],F=["CSS"],h={__name:"front_tailwindcss-tentative",setup(e,{expose:n}){const s={title:"Tailwind CSS \u521D\u63A2",date:"2021-02-04T00:00:00.000Z",category:"comp",tags:["frontend"],keywords:["CSS"]};return n({frontmatter:s}),(t,c)=>{const a=l;return o(),p(a,{frontmatter:s,inner:`<div><p>Tailwind CSS \u4ECE\u771F\u9999\u5230\u653E\u5F03\u7684\u4E2A\u4EBA\u7ECF\u5386\u3002</p>
<!-- more -->
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #ABB2BF">&lt;</span><span style="color: #E06C75">header</span></span>
...
<p>\u7B49\u4E8E\u5982\u4E0B\u7684 CSS\uFF1A</p>
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #D19A66">.this-header</span><span style="color: #ABB2BF"> {</span></span>
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #D19A66">.whatever</span><span style="color: #ABB2BF"> {</span></span>
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #D19A66">.btn</span><span style="color: #ABB2BF"> {</span></span>
...
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #D19A66">.container</span><span style="color: #ABB2BF"> {</span></span>
...
<span class="line"></span></code></pre>
<p>\u5C31\u9700\u8981\u586B\u914D\u7F6E\u6587\u4EF6\uFF1A</p>
<pre class="shiki" style="background-color: #282c34"><code><span class="line"><span style="color: #E5C07B">module</span><span style="color: #ABB2BF">.</span><span style="color: #E5C07B">exports</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">=</span><span style="color: #ABB2BF"> {</span></span>
...
</div>`})}}};export{A as category,y as date,h as default,F as keywords,d as tags,i as title};
